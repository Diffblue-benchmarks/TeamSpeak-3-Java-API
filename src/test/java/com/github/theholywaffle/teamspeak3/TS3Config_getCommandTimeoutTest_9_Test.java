...
public class TS3Config_getCommandTimeoutTest_9_Test {
  @Test
  public void getCommandTimeoutTest() throws Exception {
    // Arrange
    TS3Config tS3Config = new TS3Config();

    // Act
    int actual = tS3Config.getCommandTimeout();

    // Assert
    Assert.assertEquals(4000, actual);
