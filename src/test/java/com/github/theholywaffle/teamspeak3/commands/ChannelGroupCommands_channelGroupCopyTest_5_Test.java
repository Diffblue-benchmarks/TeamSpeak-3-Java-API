...
public class ChannelGroupCommands_channelGroupCopyTest_5_Test {
  @Test
  public void channelGroupCopyTest() throws Exception {
    ...
    // Act
    Command actual = ChannelGroupCommands.channelGroupCopy(sourceGroupId, targetGroupId, type);
    ...
    Assert.assertEquals("channelgroupcopy scgid=1 tcgid=1 name=name type=0", toStringResult);
