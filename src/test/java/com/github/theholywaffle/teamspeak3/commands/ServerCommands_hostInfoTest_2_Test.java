...
public class ServerCommands_hostInfoTest_2_Test {
  @Test
  public void hostInfoTest() throws Exception {
    // Arrange and Act
    Command actual = ServerCommands.hostInfo();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("hostinfo", name);
    ...
    Assert.assertEquals("hostinfo", toStringResult);
