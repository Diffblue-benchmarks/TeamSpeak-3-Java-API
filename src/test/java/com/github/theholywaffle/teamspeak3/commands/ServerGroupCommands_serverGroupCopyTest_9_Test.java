...
public class ServerGroupCommands_serverGroupCopyTest_9_Test {
  @Test
  public void serverGroupCopyTest() throws Exception {
    ...
    // Act
    Command actual = ServerGroupCommands.serverGroupCopy(sourceGroupId, groupName, type);
    ...
    Assert.assertEquals("servergroupcopy ssgid=1 tsgid=0 name=aaaaa type=0", toStringResult);
