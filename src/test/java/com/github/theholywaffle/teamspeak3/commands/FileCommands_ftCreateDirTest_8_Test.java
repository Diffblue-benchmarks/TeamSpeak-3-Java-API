...
public class FileCommands_ftCreateDirTest_8_Test {
  @Test
  public void ftCreateDirTest() throws Exception {
    // Arrange
    String path = "aaaaa";
    int channelId = 1;
    ...
    // Act
    Command actual = FileCommands.ftCreateDir(path, channelId, channelPassword);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("ftcreatedir", name);
    ...
    Assert.assertEquals("ftcreatedir cid=1 cpw=aaaaa dirname=\\/aaaaa", toStringResult);
