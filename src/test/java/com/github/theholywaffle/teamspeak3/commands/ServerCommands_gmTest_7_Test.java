...
public class ServerCommands_gmTest_7_Test {
  @Test
  public void gmTest() throws Exception {
    ...
    Assert.assertEquals("gm msg=aaaaa", toStringResult);
