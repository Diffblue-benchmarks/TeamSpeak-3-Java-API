...
public class ClientCommands_clientMoveTest_6_Test {
  @Test
  public void clientMoveTest() throws Exception {
    ...
    // Act
    Command actual = ClientCommands.clientMove(clientId, channelId, channelPassword);
    ...
    Assert.assertEquals("clientmove clid=1 cid=1 cpw=aaaaa", toStringResult);
