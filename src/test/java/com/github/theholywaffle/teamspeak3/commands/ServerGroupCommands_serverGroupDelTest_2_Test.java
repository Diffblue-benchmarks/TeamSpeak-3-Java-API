...
public class ServerGroupCommands_serverGroupDelTest_2_Test {
  @Test
  public void serverGroupDelTest() throws Exception {
    // Arrange
    int id = 1;
    boolean force = true;

    // Act
    Command actual = ServerGroupCommands.serverGroupDel(id, force);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("servergroupdel", name);
    ...
    Assert.assertEquals("servergroupdel sgid=1 force=1", toStringResult);
