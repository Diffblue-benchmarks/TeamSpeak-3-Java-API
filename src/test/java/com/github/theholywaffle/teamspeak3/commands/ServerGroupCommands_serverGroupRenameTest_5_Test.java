...
public class ServerGroupCommands_serverGroupRenameTest_5_Test {
  @Test
  public void serverGroupRenameTest() throws Exception {
    // Arrange
    int id = 1;
    String groupName = "aaaaa";

    // Act
    Command actual = ServerGroupCommands.serverGroupRename(id, groupName);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("servergrouprename", name);
    ...
    Assert.assertEquals("servergrouprename sgid=1 name=aaaaa", toStringResult);
