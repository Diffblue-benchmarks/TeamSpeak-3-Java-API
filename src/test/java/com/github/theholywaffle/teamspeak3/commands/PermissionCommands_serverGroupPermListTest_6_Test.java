...
public class PermissionCommands_serverGroupPermListTest_6_Test {
  @Test
  public void serverGroupPermListTest() throws Exception {
    // Arrange
    int groupId = 1;

    // Act
    Command actual = PermissionCommands.serverGroupPermList(groupId);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("servergrouppermlist", name);
    ...
    Assert.assertEquals("servergrouppermlist sgid=1 -permsid", toStringResult);
