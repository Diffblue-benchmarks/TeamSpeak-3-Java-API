...
public class ClientCommands_clientListTest_11_Test {
  @Test
  public void clientListTest() throws Exception {
    // Arrange and Act
    Command actual = ClientCommands.clientList();

    // Assert
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("clientlist -uid -away -voice -times -groups -info -icon -country -ip -badges", toStringResult);
