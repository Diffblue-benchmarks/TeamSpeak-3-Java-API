...
public class VirtualServerCommands_serverSnapshotCreateTest_3_Test {
  @Test
  public void serverSnapshotCreateTest() throws Exception {
    // Arrange and Act
    Command actual = VirtualServerCommands.serverSnapshotCreate();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("serversnapshotcreate", name);
    ...
    Assert.assertEquals("serversnapshotcreate", toStringResult);
