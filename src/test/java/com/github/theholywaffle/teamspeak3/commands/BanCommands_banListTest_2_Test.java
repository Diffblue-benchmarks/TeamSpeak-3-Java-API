...
public class BanCommands_banListTest_2_Test {
  @Test
  public void banListTest() throws Exception {
    // Arrange and Act
    Command actual = BanCommands.banList();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("banlist", name);
    ...
    Assert.assertEquals("banlist", toStringResult);
