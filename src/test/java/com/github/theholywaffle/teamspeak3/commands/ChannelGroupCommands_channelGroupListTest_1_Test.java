...
public class ChannelGroupCommands_channelGroupListTest_1_Test {
  @Test
  public void channelGroupListTest() throws Exception {
    // Arrange and Act
    Command actual = ChannelGroupCommands.channelGroupList();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("channelgrouplist", name);
    ...
    Assert.assertEquals("channelgrouplist", toStringResult);
