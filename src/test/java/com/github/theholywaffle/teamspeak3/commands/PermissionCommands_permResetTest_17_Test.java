...
public class PermissionCommands_permResetTest_17_Test {
  @Test
  public void permResetTest() throws Exception {
    // Arrange and Act
    Command actual = PermissionCommands.permReset();

    // Assert
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("permreset", toStringResult);
