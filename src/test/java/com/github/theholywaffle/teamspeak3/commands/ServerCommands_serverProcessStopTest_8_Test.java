...
public class ServerCommands_serverProcessStopTest_8_Test {
  @Test
  public void serverProcessStopTest() throws Exception {
    // Arrange
    String reason = "aaaaa";

    // Act
    Command actual = ServerCommands.serverProcessStop(reason);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("serverprocessstop", name);
    ...
    Assert.assertEquals("serverprocessstop reasonmsg=aaaaa", toStringResult);
