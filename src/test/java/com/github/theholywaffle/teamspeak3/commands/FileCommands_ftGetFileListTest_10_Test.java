...
public class FileCommands_ftGetFileListTest_10_Test {
  @Test
  public void ftGetFileListTest() throws Exception {
    // Arrange
    ...
    // Act
    Command actual = FileCommands.ftGetFileList(directoryPath, channelId, channelPassword);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("ftgetfilelist", name);
    ...
    Assert.assertEquals("ftgetfilelist cid=1 cpw=aaaaa path=\\/aaaaa\\/", toStringResult);
