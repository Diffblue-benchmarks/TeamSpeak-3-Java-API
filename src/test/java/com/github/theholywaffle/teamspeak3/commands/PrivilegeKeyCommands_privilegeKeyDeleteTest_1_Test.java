...
public class PrivilegeKeyCommands_privilegeKeyDeleteTest_1_Test {
  @Test
  public void privilegeKeyDeleteTest() throws Exception {
    // Arrange
    String token = "aaaaa";

    // Act
    Command actual = PrivilegeKeyCommands.privilegeKeyDelete(token);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("privilegekeydelete", name);
    ...
    Assert.assertEquals("privilegekeydelete token=aaaaa", toStringResult);
