...
public class PermissionCommands_channelClientDelPermTest_14_Test {
  @Test
  public void channelClientDelPermTest() throws Exception {
    // Arrange
    int channelId = 1;
    int clientDBId = 1;
    ...
    // Act
    Command actual = PermissionCommands.channelClientDelPerm(channelId, clientDBId, permName);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("channelclientdelperm", name);
    ...
    Assert.assertEquals("channelclientdelperm cid=1 cldbid=1 permsid=aaaaa", toStringResult);
