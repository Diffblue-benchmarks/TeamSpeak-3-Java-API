...
public class ChannelGroupCommands_channelGroupDelTest_8_Test {
  @Test
  public void channelGroupDelTest() throws Exception {
    // Arrange
    int channelGroupId = 1;
    boolean forced = true;

    // Act
    Command actual = ChannelGroupCommands.channelGroupDel(channelGroupId, forced);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("channelgroupdel", name);
    ...
    Assert.assertEquals("channelgroupdel cgid=1 force=1", toStringResult);
