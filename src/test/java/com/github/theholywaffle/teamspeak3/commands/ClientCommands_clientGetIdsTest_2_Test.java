...
public class ClientCommands_clientGetIdsTest_2_Test {
  @Test
  public void clientGetIdsTest() throws Exception {
    // Arrange
    String clientUId = "aaaaa";

    // Act
    Command actual = ClientCommands.clientGetIds(clientUId);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("clientgetids", name);
    ...
    Assert.assertEquals("clientgetids cluid=aaaaa", toStringResult);
