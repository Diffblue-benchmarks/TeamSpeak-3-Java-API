...
public class PermissionCommands_channelGroupAddPermTest_19_Test {
  @Test
  public void channelGroupAddPermTest() throws Exception {
    // Arrange
    int groupId = 1;
    ...
    // Act
    Command actual = PermissionCommands.channelGroupAddPerm(groupId, permName, permValue);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("channelgroupaddperm", name);
    ...
    Assert.assertEquals("channelgroupaddperm cgid=1 permsid=aaaaa permvalue=1", toStringResult);
