...
public class ServerGroupCommands_serverGroupListTest_10_Test {
  @Test
  public void serverGroupListTest() throws Exception {
    // Arrange and Act
    Command actual = ServerGroupCommands.serverGroupList();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("servergrouplist", name);
    ...
    Assert.assertEquals("servergrouplist", toStringResult);
