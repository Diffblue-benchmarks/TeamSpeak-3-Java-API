...
public class MessageCommands_messageListTest_1_Test {
  @Test
  public void messageListTest() throws Exception {
    // Arrange and Act
    Command actual = MessageCommands.messageList();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("messagelist", name);
    ...
    Assert.assertEquals("messagelist", toStringResult);
