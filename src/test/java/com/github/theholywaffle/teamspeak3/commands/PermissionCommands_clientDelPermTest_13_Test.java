...
public class PermissionCommands_clientDelPermTest_13_Test {
  @Test
  public void clientDelPermTest() throws Exception {
    // Arrange
    int clientDBId = 1;
    String permName = "aaaaa";

    // Act
    Command actual = PermissionCommands.clientDelPerm(clientDBId, permName);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("clientdelperm", name);
    ...
    Assert.assertEquals("clientdelperm cldbid=1 permsid=aaaaa", toStringResult);
