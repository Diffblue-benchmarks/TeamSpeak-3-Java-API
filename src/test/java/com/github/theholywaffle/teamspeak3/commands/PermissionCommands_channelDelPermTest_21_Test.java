...
public class PermissionCommands_channelDelPermTest_21_Test {
  @Test
  public void channelDelPermTest() throws Exception {
    // Arrange
    int channelId = 1;
    String permName = "aaaaa";

    // Act
    Command actual = PermissionCommands.channelDelPerm(channelId, permName);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("channeldelperm", name);
    ...
    Assert.assertEquals("channeldelperm cid=1 permsid=aaaaa", toStringResult);
