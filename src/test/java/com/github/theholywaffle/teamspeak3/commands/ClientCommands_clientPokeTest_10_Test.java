...
public class ClientCommands_clientPokeTest_10_Test {
  @Test
  public void clientPokeTest() throws Exception {
    // Arrange
    int clientId = 1;
    String message = "aaaaa";

    // Act
    Command actual = ClientCommands.clientPoke(clientId, message);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("clientpoke", name);
    ...
    Assert.assertEquals("clientpoke clid=1 msg=aaaaa", toStringResult);
