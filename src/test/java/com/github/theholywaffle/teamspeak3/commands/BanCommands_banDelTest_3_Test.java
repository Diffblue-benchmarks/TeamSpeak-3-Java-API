...
public class BanCommands_banDelTest_3_Test {
  @Test
  public void banDelTest() throws Exception {
    // Arrange
    int banId = 1;

    // Act
    Command actual = BanCommands.banDel(banId);

    // Assert
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("bandel banid=1", toStringResult);
