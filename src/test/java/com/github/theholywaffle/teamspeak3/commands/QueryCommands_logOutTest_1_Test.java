...
public class QueryCommands_logOutTest_1_Test {
  @Test
  public void logOutTest() throws Exception {
    // Arrange and Act
    Command actual = QueryCommands.logOut();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("logout", name);
    ...
    Assert.assertEquals("logout", toStringResult);
