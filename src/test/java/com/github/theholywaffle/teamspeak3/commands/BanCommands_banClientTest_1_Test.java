...
public class BanCommands_banClientTest_1_Test {
  @Test
  public void banClientTest() throws Exception {
    ...
    // Act
    Command actual = BanCommands.banClient(clientId, timeInSeconds, reason);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("banclient", name);
    ...
    Assert.assertEquals("banclient clid=1 time=1 banreason=aaaaa", toStringResult);
