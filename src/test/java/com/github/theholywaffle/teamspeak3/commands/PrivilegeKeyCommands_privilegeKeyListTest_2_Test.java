...
public class PrivilegeKeyCommands_privilegeKeyListTest_2_Test {
  @Test
  public void privilegeKeyListTest() throws Exception {
    // Arrange and Act
    Command actual = PrivilegeKeyCommands.privilegeKeyList();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("privilegekeylist", name);
    ...
    Assert.assertEquals("privilegekeylist", toStringResult);
