...
public class PermissionCommands_channelGroupDelPermTest_20_Test {
  @Test
  public void channelGroupDelPermTest() throws Exception {
    // Arrange
    int groupId = 1;
    String permName = "aaaaa";

    // Act
    Command actual = PermissionCommands.channelGroupDelPerm(groupId, permName);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("channelgroupdelperm", name);
    ...
    Assert.assertEquals("channelgroupdelperm cgid=1 permsid=aaaaa", toStringResult);
