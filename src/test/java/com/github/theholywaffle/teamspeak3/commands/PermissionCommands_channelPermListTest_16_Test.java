...
public class PermissionCommands_channelPermListTest_16_Test {
  @Test
  public void channelPermListTest() throws Exception {
    // Arrange
    int channelId = 1;

    // Act
    Command actual = PermissionCommands.channelPermList(channelId);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("channelpermlist", name);
    ...
    Assert.assertEquals("channelpermlist cid=1 -permsid", toStringResult);
