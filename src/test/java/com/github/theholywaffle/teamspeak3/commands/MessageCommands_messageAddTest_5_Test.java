...
public class MessageCommands_messageAddTest_5_Test {
  @Test
  public void messageAddTest() throws Exception {
    ...
    // Act
    Command actual = MessageCommands.messageAdd(clientUId, subject, message);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("messageadd", name);
    ...
    Assert.assertEquals("messageadd cluid=aaaaa subject=aaaaa message=aaaaa", toStringResult);
