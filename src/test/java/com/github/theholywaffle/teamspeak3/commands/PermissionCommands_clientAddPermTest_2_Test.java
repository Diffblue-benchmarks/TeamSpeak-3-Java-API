...
public class PermissionCommands_clientAddPermTest_2_Test {
  @Test
  public void clientAddPermTest() throws Exception {
    // Arrange
    int clientDBId = 1;
    ...
    // Act
    Command actual = PermissionCommands.clientAddPerm(clientDBId, permName, permValue, skip);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("clientaddperm", name);
    ...
    Assert.assertEquals("clientaddperm cldbid=1 permsid=aaaaa permvalue=1 permskip=1", toStringResult);
