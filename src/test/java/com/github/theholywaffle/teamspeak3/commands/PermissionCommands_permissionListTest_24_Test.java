...
public class PermissionCommands_permissionListTest_24_Test {
  @Test
  public void permissionListTest() throws Exception {
    // Arrange and Act
    Command actual = PermissionCommands.permissionList();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("permissionlist", name);
    ...
    Assert.assertEquals("permissionlist", toStringResult);
