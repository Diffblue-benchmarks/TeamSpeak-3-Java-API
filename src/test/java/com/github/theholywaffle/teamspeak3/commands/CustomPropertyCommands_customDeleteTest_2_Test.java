...
public class CustomPropertyCommands_customDeleteTest_2_Test {
  @Test
  public void customDeleteTest() throws Exception {
    // Arrange
    int clientDBId = 1;
    String key = "aaaaa";

    // Act
    Command actual = CustomPropertyCommands.customDelete(clientDBId, key);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("customdelete", name);
    ...
    Assert.assertEquals("customdelete cldbid=1 ident=aaaaa", toStringResult);
