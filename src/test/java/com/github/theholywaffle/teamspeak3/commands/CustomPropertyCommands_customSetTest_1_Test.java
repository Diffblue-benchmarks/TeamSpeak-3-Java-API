...
public class CustomPropertyCommands_customSetTest_1_Test {
  @Test
  public void customSetTest() throws Exception {
    // Arrange
    int clientDBId = 1;
    String key = "aaaaa";
    String value = "aaaaa";
    ...
    // Act
    Command actual = CustomPropertyCommands.customSet(clientDBId, key, value);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("customset", name);
    ...
    Assert.assertEquals("customset cldbid=1 ident=aaaaa value=aaaaa", toStringResult);
