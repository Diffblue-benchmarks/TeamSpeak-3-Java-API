...
public class ServerGroupCommands_serverGroupClientListTest_4_Test {
  @Test
  public void serverGroupClientListTest() throws Exception {
    // Arrange
    int groupId = 1;

    // Act
    Command actual = ServerGroupCommands.serverGroupClientList(groupId);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("servergroupclientlist", name);
    ...
    Assert.assertEquals("servergroupclientlist sgid=1 -names", toStringResult);
