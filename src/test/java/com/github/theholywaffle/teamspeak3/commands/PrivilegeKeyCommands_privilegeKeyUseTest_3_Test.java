...
public class PrivilegeKeyCommands_privilegeKeyUseTest_3_Test {
  @Test
  public void privilegeKeyUseTest() throws Exception {
    // Arrange
    String token = "aaaaa";

    // Act
    Command actual = PrivilegeKeyCommands.privilegeKeyUse(token);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("privilegekeyuse", name);
    ...
    Assert.assertEquals("privilegekeyuse token=aaaaa", toStringResult);
