...
public class MessageCommands_messageDelTest_3_Test {
  @Test
  public void messageDelTest() throws Exception {
    // Arrange
    int messageId = 1;

    // Act
    Command actual = MessageCommands.messageDel(messageId);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("messagedel", name);
    ...
    Assert.assertEquals("messagedel msgid=1", toStringResult);
