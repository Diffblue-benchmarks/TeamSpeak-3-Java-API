...
public class DatabaseClientCommands_clientDBListTest_3_Test {
  @Test
  public void clientDBListTest() throws Exception {
    // Arrange
    int begin = 1;
    int amount = 1;
    boolean count = true;
    ...
    // Act
    Command actual = DatabaseClientCommands.clientDBList(begin, amount, count);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("clientdblist", name);
    ...
    Assert.assertEquals("clientdblist start=1 duration=1 -count", toStringResult);
