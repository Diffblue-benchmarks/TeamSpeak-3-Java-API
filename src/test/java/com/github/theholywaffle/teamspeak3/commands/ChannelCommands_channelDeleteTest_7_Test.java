...
public class ChannelCommands_channelDeleteTest_7_Test {
  @Test
  public void channelDeleteTest() throws Exception {
    ...
    // Act
    Command actual = ChannelCommands.channelDelete(channelId, force);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("channeldelete", name);
    ...
    Assert.assertEquals("channeldelete cid=1 force=1", toStringResult);
