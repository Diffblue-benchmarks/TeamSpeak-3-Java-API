...
public class ChannelCommands_channelListTest_5_Test {
  @Test
  public void channelListTest() throws Exception {
    // Arrange and Act
    Command actual = ChannelCommands.channelList();

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("channellist", name);
    ...
    Assert.assertEquals("channellist -topic -flags -voice -limits -icon -secondsempty", toStringResult);
