...
public class ComplaintCommands_complainListTest_1_Test {
  @Test
  public void complainListTest() throws Exception {
    // Arrange
    int clientDBId = 1;

    // Act
    Command actual = ComplaintCommands.complainList(clientDBId);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("complainlist", name);
    ...
    Assert.assertEquals("complainlist tcldbid=1", toStringResult);
