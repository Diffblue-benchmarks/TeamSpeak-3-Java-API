...
public class ClientCommands_sendTextMessageTest_5_Test {
  @Test
  public void sendTextMessageTest() throws Exception {
    ...
    // Act
    Command actual = ClientCommands.sendTextMessage(targetMode, targetId, message);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("sendtextmessage", name);
    ...
    Assert.assertEquals("sendtextmessage targetmode=1 target=1 msg=aaaaa", toStringResult);
