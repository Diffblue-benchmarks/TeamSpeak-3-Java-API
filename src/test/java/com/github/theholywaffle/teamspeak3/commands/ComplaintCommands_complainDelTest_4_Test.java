...
public class ComplaintCommands_complainDelTest_4_Test {
  @Test
  public void complainDelTest() throws Exception {
    // Arrange
    int clientDBId = 1;
    int fromClientDBId = 1;

    // Act
    Command actual = ComplaintCommands.complainDel(clientDBId, fromClientDBId);

    // Assert
    String name = actual.getName();
    String toStringResult = actual.toString();
    CommandFuture<DefaultArrayResponse> future = actual.getFuture();
    Assert.assertEquals("complaindel", name);
    ...
    Assert.assertEquals("complaindel tcldbid=1 fcldbid=1", toStringResult);
