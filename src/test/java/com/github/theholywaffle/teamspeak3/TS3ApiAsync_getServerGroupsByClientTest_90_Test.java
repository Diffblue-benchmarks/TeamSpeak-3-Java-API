...
public class TS3ApiAsync_getServerGroupsByClientTest_90_Test {
  @Test
  public void getServerGroupsByClientTest() throws Exception {
    // Arrange
    ...
    tS3ApiAsync.getServerGroupsByClient(client);
