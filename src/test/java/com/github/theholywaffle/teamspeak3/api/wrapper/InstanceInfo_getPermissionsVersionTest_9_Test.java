...
public class InstanceInfo_getPermissionsVersionTest_9_Test {
  @Test
  public void getPermissionsVersionTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = instanceInfo.getPermissionsVersion();
