...
public class InstanceInfo_getFileTransferPortTest_3_Test {
  @Test
  public void getFileTransferPortTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = instanceInfo.getFileTransferPort();
