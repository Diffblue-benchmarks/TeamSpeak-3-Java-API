...
public class VirtualServer_getQueryClientsOnlineTest_8_Test {
  @Test
  public void getQueryClientsOnlineTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = virtualServer.getQueryClientsOnline();
