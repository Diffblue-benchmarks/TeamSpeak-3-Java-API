...
public class IconFile_IconFileTest_2_Test {
//failed_pass   @Test
//  public void IconFileTest() throws Exception {
//    // Arrange
//    HashMap<String, String> hashMap = new HashMap<String, String>();
//    hashMap.put("aaaaa", "aaaaa");
//
//    // Act
//    IconFile iconFile = new IconFile(hashMap);
//
//    // Assert
//    int type = iconFile.getType();
//    long uploadedBytes = iconFile.getUploadedBytes();
//    String name = iconFile.getName();
//    String toStringResult = iconFile.toString();
//    boolean isStillUploadingResult = iconFile.isStillUploading();
//    int channelId = iconFile.getChannelId();
//    String parentPath = iconFile.getParentPath();
//    boolean isFileResult = iconFile.isFile();
//    Date lastModifiedDate = iconFile.getLastModifiedDate();
//    Map<String, String> map = iconFile.getMap();
//    String path = iconFile.getPath();
//    boolean isDirectoryResult = iconFile.isDirectory();
//    long iconId = iconFile.getIconId();
//    Assert.assertEquals(-1, type);
//    Assert.assertEquals(-1L, iconFile.getFileSize());
