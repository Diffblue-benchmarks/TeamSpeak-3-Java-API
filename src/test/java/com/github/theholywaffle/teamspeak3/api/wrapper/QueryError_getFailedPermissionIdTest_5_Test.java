...
public class QueryError_getFailedPermissionIdTest_5_Test {
  @Test
  public void getFailedPermissionIdTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = queryError.getFailedPermissionId();
