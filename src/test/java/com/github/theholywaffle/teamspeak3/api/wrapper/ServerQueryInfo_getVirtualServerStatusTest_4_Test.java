...
public class ServerQueryInfo_getVirtualServerStatusTest_4_Test {
  @Test
  public void getVirtualServerStatusTest() throws Exception {
    // Arrange
    ...
    // Act
    VirtualServerStatus actual = serverQueryInfo.getVirtualServerStatus();

    // Assert
    Assert.assertEquals(VirtualServerStatus.UNKNOWN, actual);
