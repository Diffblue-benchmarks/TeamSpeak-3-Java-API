...
public class ServerQueryInfo_getVirtualServerIdTest_1_Test {
  @Test
  public void getVirtualServerIdTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = serverQueryInfo.getVirtualServerId();
