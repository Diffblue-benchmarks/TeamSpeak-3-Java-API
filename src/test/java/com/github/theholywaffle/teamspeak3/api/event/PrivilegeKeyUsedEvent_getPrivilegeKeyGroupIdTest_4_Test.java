...
public class PrivilegeKeyUsedEvent_getPrivilegeKeyGroupIdTest_4_Test {
  @Test
  public void getPrivilegeKeyGroupIdTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = privilegeKeyUsedEvent.getPrivilegeKeyGroupId();
