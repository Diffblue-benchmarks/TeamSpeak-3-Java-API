...
public class ServerQueryInfo_getOriginServerIdTest_2_Test {
  @Test
  public void getOriginServerIdTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = serverQueryInfo.getOriginServerId();
