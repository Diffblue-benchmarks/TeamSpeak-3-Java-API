...
public class FileTransferParameters_getFileServerPortTest_5_Test {
  @Test
  public void getFileServerPortTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = fileTransferParameters.getFileServerPort();
