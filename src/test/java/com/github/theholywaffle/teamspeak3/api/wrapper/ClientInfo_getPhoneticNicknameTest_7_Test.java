...
public class ClientInfo_getPhoneticNicknameTest_7_Test {
  @Test
  public void getPhoneticNicknameTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = clientInfo.getPhoneticNickname();
