...
public class ClientJoinEvent_ClientJoinEventTest_6_Test {
  @Test
  public void ClientJoinEventTest() throws Exception {
    // Arrange
    ...
    // Act
    ClientJoinEvent clientJoinEvent = new ClientJoinEvent(wrapper);
