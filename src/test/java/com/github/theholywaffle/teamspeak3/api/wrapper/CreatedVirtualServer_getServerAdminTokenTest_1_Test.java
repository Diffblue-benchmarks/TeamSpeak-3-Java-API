...
public class CreatedVirtualServer_getServerAdminTokenTest_1_Test {
  @Test
  public void getServerAdminTokenTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = createdVirtualServer.getServerAdminToken();
