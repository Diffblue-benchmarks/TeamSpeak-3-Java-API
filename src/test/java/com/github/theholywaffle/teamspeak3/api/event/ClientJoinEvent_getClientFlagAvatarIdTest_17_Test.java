...
public class ClientJoinEvent_getClientFlagAvatarIdTest_17_Test {
  @Test
  public void getClientFlagAvatarIdTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = clientJoinEvent.getClientFlagAvatarId();
