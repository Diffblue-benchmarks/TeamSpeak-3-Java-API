...
public class ChannelInfo_hasInheritedMaxFamilyClientsTest_12_Test {
  @Test
  public void hasInheritedMaxFamilyClientsTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = channelInfo.hasInheritedMaxFamilyClients();
