...
public class ChannelInfo_hasUnlimitedFamilyClientsTest_9_Test {
  @Test
  public void hasUnlimitedFamilyClientsTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = channelInfo.hasUnlimitedFamilyClients();
