...
public class ClientJoinEvent_getClientTalkPowerTest_2_Test {
  @Test
  public void getClientTalkPowerTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = clientJoinEvent.getClientTalkPower();
