...
public class PrivilegeKeyUsedEvent_getPrivilegeKeyChannelIdTest_3_Test {
  @Test
  public void getPrivilegeKeyChannelIdTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = privilegeKeyUsedEvent.getPrivilegeKeyChannelId();
