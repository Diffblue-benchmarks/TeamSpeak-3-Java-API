...
public class InstanceInfo_getChannelAdminGroupTest_4_Test {
  @Test
  public void getChannelAdminGroupTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = instanceInfo.getChannelAdminGroup();
