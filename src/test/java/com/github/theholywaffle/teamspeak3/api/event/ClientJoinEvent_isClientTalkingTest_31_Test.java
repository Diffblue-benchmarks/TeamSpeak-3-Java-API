...
public class ClientJoinEvent_isClientTalkingTest_31_Test {
  @Test
  public void isClientTalkingTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientTalking();
