...
public class ChannelGroup_getMemberRemovePowerTest_8_Test {
  @Test
  public void getMemberRemovePowerTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = channelGroup.getMemberRemovePower();
