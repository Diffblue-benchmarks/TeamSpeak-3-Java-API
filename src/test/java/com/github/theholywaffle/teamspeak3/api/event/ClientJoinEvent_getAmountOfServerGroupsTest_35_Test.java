...
public class ClientJoinEvent_getAmountOfServerGroupsTest_35_Test {
  @Test
  public void getAmountOfServerGroupsTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = clientJoinEvent.getAmountOfServerGroups();
