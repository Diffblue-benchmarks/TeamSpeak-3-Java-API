...
public class ClientJoinEvent_getClientDescriptionTest_18_Test {
  @Test
  public void getClientDescriptionTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = clientJoinEvent.getClientDescription();
