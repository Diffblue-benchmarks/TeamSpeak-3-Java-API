...
public class ClientJoinEvent_isClientOutputMutedTest_19_Test {
  @Test
  public void isClientOutputMutedTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientOutputMuted();
