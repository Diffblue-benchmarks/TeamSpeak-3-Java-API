...
public class InstanceInfo_getGuestServerQueryGroupTest_11_Test {
  @Test
  public void getGuestServerQueryGroupTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = instanceInfo.getGuestServerQueryGroup();
