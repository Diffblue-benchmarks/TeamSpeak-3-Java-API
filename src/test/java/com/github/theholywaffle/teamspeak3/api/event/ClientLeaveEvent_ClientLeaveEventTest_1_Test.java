...
public class ClientLeaveEvent_ClientLeaveEventTest_1_Test {
  @Test
  public void ClientLeaveEventTest() throws Exception {
    // Arrange
    ...
    // Act
    ClientLeaveEvent clientLeaveEvent = new ClientLeaveEvent(wrapper);
