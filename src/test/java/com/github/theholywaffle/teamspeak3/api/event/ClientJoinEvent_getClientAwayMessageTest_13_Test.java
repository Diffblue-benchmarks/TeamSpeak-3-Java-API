...
public class ClientJoinEvent_getClientAwayMessageTest_13_Test {
  @Test
  public void getClientAwayMessageTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = clientJoinEvent.getClientAwayMessage();
