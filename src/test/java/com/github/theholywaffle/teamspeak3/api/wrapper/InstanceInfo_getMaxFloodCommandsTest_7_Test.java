...
public class InstanceInfo_getMaxFloodCommandsTest_7_Test {
  @Test
  public void getMaxFloodCommandsTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = instanceInfo.getMaxFloodCommands();
