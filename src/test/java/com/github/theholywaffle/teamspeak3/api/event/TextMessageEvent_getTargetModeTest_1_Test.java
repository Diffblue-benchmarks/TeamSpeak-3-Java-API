...
public class TextMessageEvent_getTargetModeTest_1_Test {
  @Test
  public void getTargetModeTest() throws Exception {
    // Arrange
    ...
    // Act
    TextMessageTargetMode actual = textMessageEvent.getTargetMode();
