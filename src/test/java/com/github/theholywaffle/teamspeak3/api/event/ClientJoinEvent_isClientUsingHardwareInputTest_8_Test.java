...
public class ClientJoinEvent_isClientUsingHardwareInputTest_8_Test {
  @Test
  public void isClientUsingHardwareInputTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientUsingHardwareInput();
