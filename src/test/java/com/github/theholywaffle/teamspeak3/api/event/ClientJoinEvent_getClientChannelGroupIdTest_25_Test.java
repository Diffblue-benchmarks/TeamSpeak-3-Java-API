...
public class ClientJoinEvent_getClientChannelGroupIdTest_25_Test {
  @Test
  public void getClientChannelGroupIdTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = clientJoinEvent.getClientChannelGroupId();
