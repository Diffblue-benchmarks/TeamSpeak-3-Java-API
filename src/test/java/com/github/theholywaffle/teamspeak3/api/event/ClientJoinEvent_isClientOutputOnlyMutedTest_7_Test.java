...
public class ClientJoinEvent_isClientOutputOnlyMutedTest_7_Test {
  @Test
  public void isClientOutputOnlyMutedTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientOutputOnlyMuted();
