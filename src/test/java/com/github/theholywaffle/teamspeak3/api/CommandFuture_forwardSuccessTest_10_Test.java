...
public class CommandFuture_forwardSuccessTest_10_Test {
  @Test
  public void forwardSuccessTest() throws Exception {
    // Arrange
    CommandFuture<Object> commandFuture = new CommandFuture<Object>();
    CommandFuture<Object> commandFuture1 = new CommandFuture<Object>();

    // Act
    CommandFuture<Object> actual = commandFuture.forwardSuccess(commandFuture1);
