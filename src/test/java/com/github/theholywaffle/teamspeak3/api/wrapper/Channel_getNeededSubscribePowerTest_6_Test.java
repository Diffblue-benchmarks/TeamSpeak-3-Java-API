...
public class Channel_getNeededSubscribePowerTest_6_Test {
  @Test
  public void getNeededSubscribePowerTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = channel.getNeededSubscribePower();
