...
public class Ban_getInvokerClientDBIdTest_9_Test {
//failed_pass   @Test
//  public void getInvokerClientDBIdTest() throws Exception {
//    // Arrange
...
//
//    // Act
//    int actual = ban.getInvokerClientDBId();
//
//    // Assert
//    Assert.assertEquals(-1, actual);
//    String invokerName = ban.getInvokerName();
//    String toStringResult = ban.toString();
...
//    int timezoneOffset = createdDate.getTimezoneOffset();
//    int hours = createdDate.getHours();
//    String toStringResult1 = createdDate.toString();
//    int minutes = createdDate.getMinutes();
//    long time = createdDate.getTime();
//    int seconds = createdDate.getSeconds();
//    int month = createdDate.getMonth();
//    int date = createdDate.getDate();
//    String toLocaleStringResult = createdDate.toLocaleString();
