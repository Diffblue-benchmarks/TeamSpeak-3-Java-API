...
public class ClientJoinEvent_isClientRequestingToTalkTest_12_Test {
  @Test
  public void isClientRequestingToTalkTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientRequestingToTalk();
