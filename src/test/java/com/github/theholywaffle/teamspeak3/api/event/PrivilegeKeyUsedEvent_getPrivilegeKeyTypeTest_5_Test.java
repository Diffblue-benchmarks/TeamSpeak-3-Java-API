...
public class PrivilegeKeyUsedEvent_getPrivilegeKeyTypeTest_5_Test {
  @Test
  public void getPrivilegeKeyTypeTest() throws Exception {
    // Arrange
    ...
    // Act
    PrivilegeKeyType actual = privilegeKeyUsedEvent.getPrivilegeKeyType();

    // Assert
    Assert.assertEquals(PrivilegeKeyType.CHANNEL_GROUP, actual);
