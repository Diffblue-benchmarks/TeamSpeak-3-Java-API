...
public class ClientJoinEvent_getClientUnreadMessagesTest_21_Test {
  @Test
  public void getClientUnreadMessagesTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = clientJoinEvent.getClientUnreadMessages();
