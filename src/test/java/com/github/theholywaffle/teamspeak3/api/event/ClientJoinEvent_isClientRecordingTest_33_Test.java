...
public class ClientJoinEvent_isClientRecordingTest_33_Test {
  @Test
  public void isClientRecordingTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientRecording();
