...
public class ChannelInfo_hasUnlimitedClientsTest_13_Test {
  @Test
  public void hasUnlimitedClientsTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = channelInfo.hasUnlimitedClients();
