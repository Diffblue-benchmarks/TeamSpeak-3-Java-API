...
public class ClientJoinEvent_getClientTalkRequestMessageTest_20_Test {
  @Test
  public void getClientTalkRequestMessageTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = clientJoinEvent.getClientTalkRequestMessage();
