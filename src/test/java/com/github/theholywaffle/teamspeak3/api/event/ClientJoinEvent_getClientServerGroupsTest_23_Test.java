...
public class ClientJoinEvent_getClientServerGroupsTest_23_Test {
  @Test
  public void getClientServerGroupsTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = clientJoinEvent.getClientServerGroups();
