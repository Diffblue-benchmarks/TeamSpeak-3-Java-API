...
public class InstanceInfo_getServerAdminGroupTest_10_Test {
  @Test
  public void getServerAdminGroupTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = instanceInfo.getServerAdminGroup();
