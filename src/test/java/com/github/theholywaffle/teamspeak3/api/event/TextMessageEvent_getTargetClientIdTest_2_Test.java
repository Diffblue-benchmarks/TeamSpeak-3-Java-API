...
public class TextMessageEvent_getTargetClientIdTest_2_Test {
  @Test
  public void getTargetClientIdTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = textMessageEvent.getTargetClientId();
