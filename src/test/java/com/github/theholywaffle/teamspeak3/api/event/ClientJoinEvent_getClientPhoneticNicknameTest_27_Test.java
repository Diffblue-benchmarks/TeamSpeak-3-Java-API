...
public class ClientJoinEvent_getClientPhoneticNicknameTest_27_Test {
  @Test
  public void getClientPhoneticNicknameTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = clientJoinEvent.getClientPhoneticNickname();
