...
public class ChannelInfo_getCodecLatencyFactorTest_5_Test {
  @Test
  public void getCodecLatencyFactorTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = channelInfo.getCodecLatencyFactor();
