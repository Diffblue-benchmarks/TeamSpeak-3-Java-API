...
public class ClientInfo_getNeededServerQueryViewPowerTest_20_Test {
  @Test
  public void getNeededServerQueryViewPowerTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = clientInfo.getNeededServerQueryViewPower();
