...
public class ClientJoinEvent_isClientUsingHardwareOutputTest_32_Test {
  @Test
  public void isClientUsingHardwareOutputTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientUsingHardwareOutput();
