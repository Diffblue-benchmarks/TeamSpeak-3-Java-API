...
public class PrivilegeKeyUsedEvent_getPrivilegeKeyTest_8_Test {
  @Test
  public void getPrivilegeKeyTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = privilegeKeyUsedEvent.getPrivilegeKey();
