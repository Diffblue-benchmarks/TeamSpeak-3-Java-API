...
public class PrivilegeKeyUsedEvent_getClientUniqueIdentifierTest_2_Test {
  @Test
  public void getClientUniqueIdentifierTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = privilegeKeyUsedEvent.getClientUniqueIdentifier();
