...
public class FileTransferParameters_getFileServerHostTest_6_Test {
  @Test
  public void getFileServerHostTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = fileTransferParameters.getFileServerHost();
