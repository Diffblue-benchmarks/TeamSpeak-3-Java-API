...
public class ClientJoinEvent_isClientPrioritySpeakerTest_11_Test {
  @Test
  public void isClientPrioritySpeakerTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientPrioritySpeaker();
