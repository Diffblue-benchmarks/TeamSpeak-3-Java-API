...
public class ClientJoinEvent_getClientMetadataTest_28_Test {
  @Test
  public void getClientMetadataTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = clientJoinEvent.getClientMetadata();
