...
public class ClientJoinEvent_isClientChannelCommanderTest_9_Test {
  @Test
  public void isClientChannelCommanderTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientChannelCommander();
