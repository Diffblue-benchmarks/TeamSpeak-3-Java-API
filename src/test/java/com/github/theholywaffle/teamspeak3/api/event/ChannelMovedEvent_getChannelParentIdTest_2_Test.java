...
public class ChannelMovedEvent_getChannelParentIdTest_2_Test {
  @Test
  public void getChannelParentIdTest() throws Exception {
    // Arrange
    ...
    // Act
    int actual = channelMovedEvent.getChannelParentId();
