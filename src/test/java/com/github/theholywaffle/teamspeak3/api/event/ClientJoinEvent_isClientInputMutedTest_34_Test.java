...
public class ClientJoinEvent_isClientInputMutedTest_34_Test {
  @Test
  public void isClientInputMutedTest() throws Exception {
    // Arrange
    ...
    // Act
    boolean actual = clientJoinEvent.isClientInputMuted();
