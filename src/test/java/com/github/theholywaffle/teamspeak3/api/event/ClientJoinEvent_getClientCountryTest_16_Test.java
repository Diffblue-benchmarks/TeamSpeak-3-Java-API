...
public class ClientJoinEvent_getClientCountryTest_16_Test {
  @Test
  public void getClientCountryTest() throws Exception {
    // Arrange
    ...
    // Act
    String actual = clientJoinEvent.getClientCountry();
