...
public class TS3Config_getEnableCommunicationsLoggingTest_20_Test {
  @Test
  public void getEnableCommunicationsLoggingTest() throws Exception {
    // Arrange
    TS3Config tS3Config = new TS3Config();

    // Act
    boolean actual = tS3Config.getEnableCommunicationsLogging();
