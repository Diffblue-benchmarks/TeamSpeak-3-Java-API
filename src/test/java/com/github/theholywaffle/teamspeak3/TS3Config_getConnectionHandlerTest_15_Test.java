...
public class TS3Config_getConnectionHandlerTest_15_Test {
  @Test
  public void getConnectionHandlerTest() throws Exception {
    // Arrange
    TS3Config tS3Config = new TS3Config();

    // Act
    ConnectionHandler actual = tS3Config.getConnectionHandler();
