...
public class TS3Config_setCommandTimeoutTest_17_Test {
  @Test
  public void setCommandTimeoutTest() throws Exception {
    // Arrange
    TS3Config tS3Config = new TS3Config();
    int commandTimeout = 1;

    // Act
    TS3Config actual = tS3Config.setCommandTimeout(commandTimeout);
    ...
    int commandTimeout1 = actual.getCommandTimeout();
    ...
    Assert.assertEquals(1, commandTimeout1);
