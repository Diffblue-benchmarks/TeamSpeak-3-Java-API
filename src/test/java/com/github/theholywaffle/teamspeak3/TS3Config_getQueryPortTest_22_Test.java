...
public class TS3Config_getQueryPortTest_22_Test {
  @Test
  public void getQueryPortTest() throws Exception {
    // Arrange
    TS3Config tS3Config = new TS3Config();

    // Act
    int actual = tS3Config.getQueryPort();

    // Assert
    Assert.assertEquals(10011, actual);
