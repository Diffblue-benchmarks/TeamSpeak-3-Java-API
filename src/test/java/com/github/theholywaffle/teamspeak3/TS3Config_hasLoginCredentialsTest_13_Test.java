...
public class TS3Config_hasLoginCredentialsTest_13_Test {
  @Test
  public void hasLoginCredentialsTest() throws Exception {
    // Arrange
    TS3Config tS3Config = new TS3Config();

    // Act
    boolean actual = tS3Config.hasLoginCredentials();
