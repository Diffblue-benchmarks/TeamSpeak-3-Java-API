...
public class TS3Config_getReconnectStrategyTest_19_Test {
  @Test
  public void getReconnectStrategyTest() throws Exception {
    // Arrange
    TS3Config tS3Config = new TS3Config();

    // Act
    ReconnectStrategy actual = tS3Config.getReconnectStrategy();
