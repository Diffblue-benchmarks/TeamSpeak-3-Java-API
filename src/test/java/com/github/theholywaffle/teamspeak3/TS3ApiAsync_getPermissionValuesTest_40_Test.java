...
public class TS3ApiAsync_getPermissionValuesTest_40_Test {
  @Test
  public void getPermissionValuesTest() throws Exception {
    // Arrange
    ...
    tS3ApiAsync.getPermissionValues(stringArray);
